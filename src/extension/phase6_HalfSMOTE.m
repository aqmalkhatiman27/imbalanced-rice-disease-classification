function phase6_HalfSMOTE(featureSet)
% phase6_HalfSMOTE (Standardized Version)
% Builds Half-SMOTE data and trains all three SVMs (L, Q, C).
...
if strcmp(featureSet, 'dct')
    ...
    tag = 'S3_DCT300_halfSMOTE'; % Generic tag for the experiment
else % pca
    selFile = 'features_selected/X_pca_sel.mat';
    augFile = 'features_augmented/X_PCA300_halfSMOTE.mat';
    XteField = 'Xte_pca_sel';
    tag = 'S3_PCA300_halfSMOTE'; % Generic tag for the experiment
end

%% 1. Build the Augmented Data File
phase6_buildHalfSMOTE(featureSet); % This builds the augmented file if needed
